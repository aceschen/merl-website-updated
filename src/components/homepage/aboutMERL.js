...
export default function aboutMERL() {
    return (
		<div className='gray-primary flex-col align-left gap-24 section-header'>
			...
			<div className="flex-row gap-64">
				<img src={birds} alt="" width={437}></img>
				<div className='flex-col align-left text-white gap-24'>
					...
					<a href={"/"}><button className="button pink" to={"/"}>Read about the TSB system &gt;</button></a>
